...
Some  are difficult:
LinkedList:11,160,234,237，238（方法二）,82,109,142,143,148(快速排序)
...
String:5,17(dfs),22(dfs),28(kmp算法)，125(正则表达式),71，91（方法一dp,方法二dfs超时了）,93（dfs）
Tree:257,105,95，96（dp）,98,107,114，144（非递归方法，方法一）,222,230,236,337
DynamicProgramming:213,221,300，304,309,322,338,375(特别难)，376（特别难，方法一贪心，方法二动态规划）,377,416(背包)
